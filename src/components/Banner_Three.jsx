        ...
        <div className='container flex justify-between items-center'>
            <div className='flex flex-col py-[118px]'>
                <div className=''>
                    ...
                    <h2 className=' font-secondary font-semibold text-primary text-[64px]
                ...
                <div className='box-1 flex flex-col gap-16'>
                    <div className='flex items-center gap-8'>
                        <div>
                            <img src="/public/Group 2.png" alt="Group 2" />
                        </div>
                        <div>
            ...
            <div className='relative'>
                ...
                className=' absolute -left-[72px] bottom-0 text-white'
                />
            </div>
        </div>

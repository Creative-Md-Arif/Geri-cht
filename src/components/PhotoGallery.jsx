...
const PhotoGallery = () => {
  ...
  return (
    <section id='photoGallery' className=' bg-[#0c0b08] bg-BG_Shadow pt-[45px] pb-5 px-10'>
        <div className='flex items-center flex-wrap'>
            <div className='py-20  w-[30%]'>
                ...
                <p className=' font-opensans font-normal text-secondary text-[16px] leading-[175%] pb-6 sm:w-auto xl:w-[420px]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Volutpat mattis ipsum turpis elit elit scelerisque egestas mu.</p>
                <div className='pt-5'>

...
const Contact = () => {
  return (
    <section id='Contact' className='Contact relative z-100 pt-[110px] pb-[146px]'>
        ...
        <div className='container flex flex-col items-center lg:flex-row lg:justify-between z-10 px-5'>
        <div className='w-full text-center lg:text-left lg:w-1/2 relative'>
            <h4 className=' font-secondary font-bold text-white text-[24px] pb-2'>Contact</h4>
            <img src="/public/Spoon-img.png" alt="" 
             className='w-10 pb-2 mx-auto lg:absolute lg:left-0'
            />
            <h2 className=' font-secondary font-semibold text-primary text-5xl xl:text-[64px] py-8 
            '>Find Us</h2>
